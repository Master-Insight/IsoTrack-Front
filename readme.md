...
Landing con autenticación obligatoria contra FastAPI. Se usa Astro + Tailwind 4.
...
2. El login hace `POST {base_url}/users/login` y guarda `accessToken`, `refreshToken` y el perfil en `localStorage`.
